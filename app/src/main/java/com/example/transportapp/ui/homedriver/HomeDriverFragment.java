...
public class HomeDriverFragment extends Fragment implements OnMapReadyCallback {
    ...
    private GeoQueryEventListener pickupGeoQueryListener = new GeoQueryEventListener() {
        ...
        public void onKeyEntered(String key, GeoLocation location) {
            ...
            UserUtilsDriver.sendNotifyToRider(getContext(), root_layout, key);
   ...
   // void OnDeclineClick() {
        ...
        FirebaseDatabase.getInstance()
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    fusedLocationProviderClient.getLastLocation()
                            ...
                            .addOnSuccessListener(location -> {
                                UserUtilsDriver.sendCompleteTripToRider(mapFragment.requireView(),getContext(),driverRequestReceived.getKey(),
                                        tripNumberId);
                    ...
                    .subscribe(returnResult -> {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                polylineList = CommonDriver.decodePoly(polyline);
                            }
    ...
    private void createGeoFireDestinationLocation(String key, LatLng destination) {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference(CommonDriver.TRIP_DESTINATION_LOCATION_REF);
    ...
    private void makeDriverOnline(Location location) {
        ...
        try {
            ...
            driversLocationRef = FirebaseDatabase.getInstance().getReference(CommonDriver.DRIVERS_LOCATION_REFERENCES)
                    .child(cityName);
    ...
    private void createGeoFirePickupLocation(String key, LatLng destination) {
        DatabaseReference ref = FirebaseDatabase.getInstance()
                .getReference(CommonDriver.TRIP_PICKUP_REF);
        ...
        FirebaseDatabase.getInstance()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        FirebaseDatabase.getInstance()
                                .getReference(CommonDriver.RIDER_INFO)
                                .child(event.getKey())
                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                    @Override
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        if (dataSnapshot.exists()) {
                                            ...
                                            fusedLocationProviderClient.getLastLocation()
                                                    ...
                                                    .addOnSuccessListener(location -> {
                                                        ...
                                                        tripPlanModel.setDriverInfoModel(CommonDriver.currentUser);
                                                        ...
                                                        tripNumberId = CommonDriver.createUniqueTripIdNumber(timeOffset);
    ...
    private void setOfflineModelForDriver(DriverRequestReceived event, String duration, String distance) {
        ...
        UserUtilsDriver.sendAcceptRequestToRider(mapFragment.getView(),getContext(),event.getKey(),tripNumberId);
    ...
    public void onNotifyToRider(NotifyToRiderEvent event)
    {
        ...
        progress_notify.setMax(CommonDriver.WAIT_TIME_IN_MIN * 60);
        waiting_timer = new CountDownTimer(CommonDriver.WAIT_TIME_IN_MIN * 60*1000,1000) {
            @Override
